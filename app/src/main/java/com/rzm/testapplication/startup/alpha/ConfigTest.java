...
public class ConfigTest {
    ...
    public void start() {
        config();
        LogUtils.log("==ALPHA== start -->" + System.currentTimeMillis());
    ...
    private void config() {
        ...
        builder.setOnProjectExecuteListener(new OnProjectExecuteListener() {
            ...
            public void onProjectStart() {
                LogUtils.log("project start");
            }

            @Override
            public void onTaskFinish(String taskName) {
                LogUtils.log("project task finish: %s" + taskName);
            }

            @Override
            public void onProjectFinish() {
                LogUtils.log("project finish.");
            }
        });
        ...
        builder.setOnGetMonitorRecordCallback(new OnGetMonitorRecordCallback() {
            ...
            public void onGetTaskExecuteRecord(Map<String, Long> result) {
                LogUtils.log("monitor result: %s" + result);
            }

            @Override
            public void onGetProjectExecuteTime(long costTime) {
                LogUtils.log("monitor time: %s" + costTime);
            }
        });
        ...
        group.addOnTaskFinishListener(new Task.OnTaskFinishListener() {
            @Override
            public void onTaskFinish(String taskName) {
                LogUtils.log("task group finish");
            }
        });
...
//        }
    ...
    public static class TaskA extends Task {
        ...
        @Override
        public void run() {
            LogUtils.log(TAG + "run task A in " + Thread.currentThread().getName());
    ...
    public static class TaskB extends Task {
        ...
        public void run() {
            ...
            LogUtils.log(TAG + "run task B in " + Thread.currentThread().getName());
        }
    }
    ...
    public static class TaskC extends Task {
        ...
        @Override
        public void run() {
            LogUtils.log(TAG + "run task C in " + Thread.currentThread().getName());
        }
    }
    ...
    public static class TaskD extends Task {
        ...
        @Override
        public void run() {
            LogUtils.log(TAG + "run task D in " + Thread.currentThread().getName());
        }
    }
    ...
    public static class TaskE extends Task {
        ...
        @Override
        public void run() {
            LogUtils.log(TAG + "run task E in " + Thread.currentThread().getName());
        }
    }
    ...
    public static class TaskF extends Task {
        ...
        @Override
        public void run() {
            LogUtils.log(TAG + "run task F in " + Thread.currentThread().getName());
        }
    }
    ...
    public static class TaskG extends Task {
        ...
        public void run() {
            ...
            LogUtils.log(TAG + " run task G in " + Thread.currentThread().getName());
        }
    }
