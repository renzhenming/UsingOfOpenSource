...
Java_com_rzm_testapplication_anr_anrmonitor_DeadLockMonitor_nativeInit(JNIEnv *env, jobject thiz,jint level) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_rzm_testapplication_anr_anrmonitor_DeadLockMonitor_getContentThreadIdArt(JNIEnv *env,jobject thiz,jlong native_thread) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_rzm_testapplication_anr_anrmonitor_DeadLockMonitor_getThreadIdFromThreadPtr(JNIEnv *env,jobject thiz,jlong nativeThread) {
